          ...
          <div className="col-12 col-md-6 d-flex justify-content-center">
            <svg id="sw-js-blob-svg" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
              ...
              <mask id='mask1' mask-type="alpha">
                <path fill="url(#sw-gradient)" d="M28.7,-17.2C34.4,-6.8,34.1,6.4,28.4,16.5C22.6,26.6,11.3,33.5,-0.6,33.9C-12.5,34.2,-24.9,27.9,-31.2,17.5C-37.4,7.2,-37.5,-7.3,-31.3,-18C-25,-28.7,-12.5,-35.8,-0.5,-35.5C11.5,-35.2,23.1,-27.6,28.7,-17.2Z" transform="translate(50 50)"></path>
              </mask>
              <g mask='url(#mask1)'>
                <path fill="url(#sw-gradient)" d="M28.7,-17.2C34.4,-6.8,34.1,6.4,28.4,16.5C22.6,26.6,11.3,33.5,-0.6,33.9C-12.5,34.2,-24.9,27.9,-31.2,17.5C-37.4,7.2,-37.5,-7.3,-31.3,-18C-25,-28.7,-12.5,-35.8,-0.5,-35.5C11.5,-35.2,23.1,-27.6,28.7,-17.2Z" transform="translate(50 50)"></path>
                <image href={ProfilePic} className='img-fluid' style={{height : "95px"}} alt="Profile" />
              </g>
            </svg>
          </div>
        </div>
