                    ...
                    <div className="row g-3">
                        <div className="col-12 col-lg-4 py-4">
                            ...
                            <div className="d-flex align-items-center gap-4 mb-3">
                                ...
                                <div className="">
                                    <p className="mb-2 text-2c3e50">Email</p>
                                    <p className="mb-2 text-2c3e50">naglayash@gmail.com</p>
                                </div>
                            </div>
                            <div className="d-flex align-items-center gap-4 mb-3">
                                <div className="">
                                ...
                                <div className="">
                                    <p className="mb-2 text-2c3e50">Phone</p>
                                    <p className="mb-2 text-2c3e50">+91 76590812357</p>
                                </div>
                            </div>
                            <div className="d-flex align-items-center gap-4 mb-3">
                                <div className="">
                                ...
                                <div className="">
                                    <p className="mb-2 text-2c3e50">Location</p>
                                    <p className="mb-2 text-2c3e50">Kamla Nehru Nagar, Ajmer Road, Jaipur</p>
                                </div>
                            </div>
                            {/* Social Link */}
                            <h6 className='text-2c3e50 mb-3'>Follow Me</h6>
